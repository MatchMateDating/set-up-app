...
export const FRONTEND_URL = process.env.EXPO_PUBLIC_FRONTEND_URL || 'https://matchmatedating.com';
...
if (__DEV__) {
  ...
  console.log('🔧 EXPO_PUBLIC_FRONTEND_URL env var:', process.env.EXPO_PUBLIC_FRONTEND_URL);
